...
function CategoryList() {
  ...
  // Au chargement du composant, on recupere la liste des categories
  useEffect(() => {
    getCategoryList()
  }, [])

  /**
   * Recuperer la liste des categories de l'API
   */
  ...
  /**
   * Defiler vers la droite la liste des categories au click sur la fleche droite
   */
    ...
    <div className='mt-10 relative'>
      ...
      <div className='flex gap-4 overflow-auto scrollbar-hide' ref={listRef}>
        {categoryList && categoryList.map((category, index) => (
          <Link
            href={'?category=' + category.slug} key={index}
            className={
